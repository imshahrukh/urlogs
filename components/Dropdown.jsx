...
const Dropdown = ({textColor}) => {
    ...
    return (
        <div className={`relative cursor-pointer`}>
            <div className={`bg-none dark:bg-gray-800 items-center flex justify-between`} onClick={() => setShow(!show)}>
                <img className="w-[19px] h-[14px]" src="/icons/flag.png" alt="" />
                <p className={`text-white dark:text-gray-400 text-sm  w-max px-2 tracking-normal font-normal ${textColor}`}>Basic Options</p>
                <div className="bg-none dark:bg-gray-800 items-center flex rounded-r border-gray-300">
                    <div className="cursor-pointer text-white dark:text-gray-400">
                        {show ? (
            ...
            {show && (
                <ul className="visible transition duration-300 opacity-100 bg-header dark:bg-gray-800  shadow rounded mt-2 py-1 w-48 absolute">
                    <li className="cursor-pointer text-white dark:text-gray-400 text-sm leading-3 tracking-normal py-3 hover:bg-gray-100 px-3 flex items-center">
                    ...
                    <li className="cursor-pointer text-white dark:text-gray-400 text-sm leading-3 tracking-normal py-3 hover:bg-gray-100 px-3 flex items-center font-normal">
